...
//import static saf.settings.AppStartupConstants.CONFIRM_BUTTON_TEXT;
...
public class AppGUI implements AppStyleArbiter {
    ...
    protected Button changeMapNameButton;
    protected Button addImageButton;
    protected Button removeImageButton;
    protected Label changeBackgroundColorLabel;
    protected ColorPicker changeBackgroundColorPicker;
    protected Label changeBorderColorLabel;
    protected ColorPicker changeBorderColorPicker;
    protected Label borderThicknessLabel;
    protected Slider borderThicknessSlider;
    protected Button reassignMapColor;
    protected Label zoomLabel;
    protected Slider zoomSlider;
    protected Button changeMapDimensonsButton;
...
//        editToolBar = new HBox();
        ...
        fileToolbarPane.getChildren().addAll(fileToolBar);
    ...
    public void initStyle() {
        ...
        newButton.getStyleClass().add(BUTTON_STYLING);
        loadButton.getStyleClass().add(BUTTON_STYLING);
        saveButton.getStyleClass().add(BUTTON_STYLING);
        exitButton.getStyleClass().add(BUTTON_STYLING);
        exportButton.getStyleClass().add(BUTTON_STYLING);
    }
}
