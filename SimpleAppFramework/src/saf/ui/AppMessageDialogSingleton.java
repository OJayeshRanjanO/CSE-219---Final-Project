...
import static saf.settings.AppStartupConstants.CLOSE_BUTTON_TEXT;
import static saf.settings.AppStartupConstants.CSS_STYLE_SHEET;
import static saf.settings.AppStartupConstants.FILE_PROTOCOL;
import static saf.settings.AppStartupConstants.PATH_SRC;
...
public class AppMessageDialogSingleton extends Stage {
    ...
    public void init(Stage owner) {
        ...
        // CLOSE BUTTON
        closeButton = new Button(CLOSE_BUTTON_TEXT);
        closeButton.setOnAction(e -> {
            AppMessageDialogSingleton.this.close();
        });

        AppMessageDialogSingleton.this.setOnCloseRequest(e -> {
            e.consume();
        });
        ...
        messageScene.getStylesheets().add(FILE_PROTOCOL + PATH_SRC + CSS_STYLE_SHEET);
        messagePane.getStyleClass().add(POP_UP_BOX);
        closeButton.getStyleClass().add(BUTTON_STYLING);
        messageLabel.getStyleClass().add(LABEL_STYLING);
    }
